...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText mEditTextRooms;
    private String name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonAddRoom = (Button)findViewById(R.id.btn_add_room);
        mEditTextRooms = (EditText)findViewById(R.id.et_rooms);
        ...
        mButtonAddRoom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                map.put(mEditTextRooms.getText().toString(), "");
